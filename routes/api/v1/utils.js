...
function normalizeTransaction(transaction) {
  ...
  return {
    ...
    environment: transaction.environment || "sandbox",
    livemode: transaction.livemode === true,
    sandboxScenario: transaction.sandboxScenario,
...
function normalizeSettlement(settlement) {
  ...
  return {
    ...
    environment: settlement.environment || "sandbox",
    livemode: settlement.livemode === true,
